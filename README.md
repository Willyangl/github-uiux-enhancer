...
![ブランチ名全表示 + コピーボタン](docs/02_gh_actions_wf_branch_copy_screenshot.png)
...
![ワークフロー通知ボタン](docs/03_watching_wf_still_complete.png)

![完了トースト通知](docs/04_wf_complete_notification.png)
...
![拡張機能ポップアップUI](docs/01_Extension_UI_Screenshot.png)
